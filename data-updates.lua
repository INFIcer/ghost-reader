...
-- IRPs (temporary requests) without wide on_tick polling.
--
-- IRPs are the "temporary item request" ghosts (e.g. set on a tile in remote
-- view), and are served by LOGISTIC robots, so they are read through
